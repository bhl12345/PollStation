package com.poll.server.service;

import com.poll.server.exception.BadRequestException;
import com.poll.server.exception.ResourceNotFoundException;
import com.poll.server.model.*;
import com.poll.server.payload.PagedResponse;
import com.poll.server.payload.PollRequest;
import com.poll.server.payload.PollResponse;
import com.poll.server.payload.VoteRequest;
import com.poll.server.repository.PollRepository;
import com.poll.server.repository.UserRepository;
import com.poll.server.repository.VoteRepository;
import com.poll.server.security.UserPrincipal;
import com.poll.server.util.AppConstants;
import com.poll.server.util.ModelMapper;
